...
import packagecitasEnespera.ActualizarCtsWt;
import packagecitasEnespera.CitasEnWait;
import packagecitasEnespera.CitasnWait;
...
public class citasESPpantalla extends javax.swing.JPanel {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ActualizarCtsWt p2=new ActualizarCtsWt();
        p2.setSize(680,420);
        p2.setLocation(0, 0);
        content.removeAll();
